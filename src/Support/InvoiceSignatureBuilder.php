...
class InvoiceSignatureBuilder
{
    ...
    public function buildSignatureXml(): string
    {
        ...
        // Extract base64 certificate content without PEM headers for XML signature
        $certContent = $this->extractCertificateContent($this->cert->getRawCertificate());
        $x509Data->addChild('ds:X509Certificate', $certContent);
