...
use KhaledHajSalem\Zatca\Support\QRCodeTags\CertificateSignature;
use KhaledHajSalem\Zatca\Support\QRCodeTags\InvoiceDate;
use KhaledHajSalem\Zatca\Support\QRCodeTags\InvoiceDigitalSignature;
use KhaledHajSalem\Zatca\Support\QRCodeTags\InvoiceHash;
use KhaledHajSalem\Zatca\Support\QRCodeTags\InvoiceTaxAmount;
use KhaledHajSalem\Zatca\Support\QRCodeTags\InvoiceTotalAmount;
use KhaledHajSalem\Zatca\Support\QRCodeTags\PublicKey;
use KhaledHajSalem\Zatca\Support\QRCodeTags\Seller;
use KhaledHajSalem\Zatca\Support\QRCodeTags\TaxNumber;
use DOMDocument;
use DOMElement;
use DOMException;
use DOMXPath;
...
class InvoiceExtension
{
    ...
    /**
     * Array to store DOMElement => InvoiceExtension mapping.
     * Using array instead of WeakMap for better compatibility.
     *
     * @var array<int, self>
     */
    ...
    public static function fromElement(DOMElement $element): self
    {
        ...
        return self::$elements[$elementId] ?? new self($element);
    }
    ...
    public function toXml(?string $version = '1.0', string $encoding = 'UTF-8', bool $format = true): string
    {
        ...
        $doc->preserveWhiteSpace = true; // Preserve whitespace to prevent hash mismatches
