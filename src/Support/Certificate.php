...
class Certificate
{
    ...
    /**
     * Create the authorization header string using the raw certificate and secret key.
     *
     * @return string
     */
    public function getAuthString(): string
    {
        return base64_encode(base64_encode($this->getRawCertificate()) . ':' . $this->getSecretKey());
    }
